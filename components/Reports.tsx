...
import { Bill, CustomerCredits, Purchase, Item, PurchasedItem } from '../types.ts';
            ...
            {reportView === 'customerCredits' && (
             ...
             {reportView === 'closingStock' && (
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                    <thead className="bg-cream-50 dark:bg-gray-700">
                        <tr>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Last Purchase</th>
                            ...
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Item Name / Code / Size</th>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Qty in Stock</th>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Last Known MRP</th>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Total Value (at cost)</th>
                        </tr>
                    </thead>
                     <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {closingStockReportData.map((row, i) => (
                             <tr key={`${row.itemCode}-${row.size}-${i}`} className="hover:bg-cream-50 dark:hover:bg-gray-700/50 transition-colors">
                                <td className="px-6 py-4 whitespace-nowrap"><Highlight text={row.purchaseDate} highlight={searchQuery}/></td>
                                <td className="px-6 py-4 whitespace-nowrap"><Highlight text={row.supplier} highlight={searchQuery}/></td>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap font-bold text-lg"><Highlight text={row.quantity} highlight={searchQuery}/></td>
                                <td className="px-6 py-4 whitespace-nowrap"><Highlight text={row.mrp === 'N/A' ? 'N/A' : `₹${row.mrp}`} highlight={searchQuery}/></td>
                                <td className="px-6 py-4 whitespace-nowrap font-semibold text-gray-800 dark:text-gray-200"><Highlight text={`₹${row.totalValue.toFixed(2)}`} highlight={searchQuery}/></td>
                            </tr>
                        ))}
                    </tbody>
                     <tfoot className="bg-cream-50 dark:bg-gray-700 font-bold">
                        <tr>
                            <td className="px-6 py-3 text-sm" colSpan={3}>Grand Total</td>
                            <td className="px-6 py-3 text-left text-sm">{closingStockTotals.totalQuantity} pcs</td>
                            <td className="px-6 py-3"></td>
                            <td className="px-6 py-3 text-left text-sm">₹{closingStockTotals.totalValue.toFixed(2)}</td>
                        </tr>
                    </tfoot>
                </table>
             )}
